...
import br.com.ufpb.nowpersonal.database.EnderecoDao;
...
public class NowPersonalApplication extends MultiDexApplication implements GoogleApiClient.OnConnectionFailedListener,
    ...
    public void onCreate() {
        ...
        instanciarUsuarioDao(dbCore.getConnectionSource());
    ...
    private void instanciarUsuarioDao(ConnectionSource connectionSource) {
        try {
            enderecoDao = new EnderecoDao(connectionSource);
    ...
    public void addOrUpdateEndereco(Endereco endereco) throws SQLException {
        enderecoDao.createOrUpdate(endereco);
    }
